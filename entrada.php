<?php
    ...
    incluirTemplate('header', 'Entrada' );

?>

    <main class="contenedor seccion contenido-centrado">
        <h1>Consejos para tener una pscina en tu casa sin gastar demasiado</h1>
        <picture>
            <source srcset="build/img/destacada2.webp" type="image/webp">
            <source srcset="build/img/destacada2.jpg" type="image/jpeg">
                <img loading="lazy" src="build/img/destacada2jpg" alt="Imagen de la Propiedad">
        </picture>
        <p class="informacion-meta">Escrito el <span>13/05/2025</span> por <span>Admin</span> </p>
